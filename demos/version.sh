...
echo "# ollama_app_version, ollama_app_version_json, ollama_app_version_cli"
...
echo
echo 'ollama_app_version'
echo
ollama_app_version

echo
echo 'ollama_app_version_json'
echo
ollama_app_version_json | jq "."

echo
echo 'ollama_app_version_cli'
echo
