...
| [generate.streaming.json.sh](demos/generate.streaming.json.sh) | Generate completion from a random model, streaming, json output                                                                | [example](demos/generate.streaming.json.txt) |
...
| [messages.sh](demos/messages.sh)                               | Adding, viewing, and clearing messages in chat context                                                                         | [example](demos/messages.txt)                |
| [ollama_chat.sh](demos/ollama_chat.sh)                         | Chat completion from a random model, non-streaming, text output                                                                | [example](demos/ollama_chat.txt)             |
...
| `ollama_chat`             | Chat completion                    | `ollama_chat`             | text to `stdout`                            | `0`/`1` | 
