...
| [ollama_model_random.md](demos/ollama_model_random.md)                  | Adding, viewing, and clearing messages in chat context                                                          | [ollama_model_random.sh](demos/ollama_model_random.sh)                 |
| [messages.md](demos/messages.md)                                        | Get a random model name                                                                                         | [messages.sh](demos/messages.sh)                                       |
