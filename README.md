...
| [`json_sanitize`](https://github.com/attogram/ollama-bash-lib/blob/main/ollama_bash_lib.sh#L55) | Sanitize a json object for jq use       | `json_sanitize "{ json object }"`                            | sanitized json object to `stdout`                               | `0`/`1` |
