...
| Demo                                                                   | About                                                                                                           | Script                                                                 |
|------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------|
| [interactive.generate.md](demos/interactive.generate.md)               | Interactive session via Generate completion                                                                     | [interactive.generate.sh](demos/interactive.generate.sh)               |
| [interactive.generate.md](demos/interactive.chat.md)                   | Interactive session via Chat completion                                                                         | [interactive.chat.sh](demos/interactive.chat.sh)                       |
