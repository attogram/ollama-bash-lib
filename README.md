...
| [prompt.all.models.md](demos/prompt.all.models.md)                     | Send the same prompt to all models                                                                              | [prompt.all.models.sh](demos/prompt.all.models.sh)                     |
| [prompts.model.md](demos/prompts.model.md)                             | Send list of prompts to a model                                                                                 | [prompts.model.sh](demos/prompts.model.sh)                             |
...
| [ollama_model_random.md](demos/ollama_model_random.md)                 | Get a random model name                                                                                         | [ollama_model_random.sh](demos/ollama_model_random.sh)                 |
...
| [messages.md](demos/messages.md)                                       | Working with messages for the chat context                                                                      | [messages.sh](demos/messages.sh)                                       |
...
| [ollama_app_vars.md](demos/ollama_app_vars.md)                         | Ollama environmental variables                                                                                  | [ollama_app_vars.sh](demos/ollama_app_vars.sh)                         |
